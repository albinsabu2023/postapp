  ...
  return (
    <div className='postCard'>
        ...
        <div className='postCardButtons'>
           ...
           { hasUserLiked ?
            <SvgIcon className="dislikeButton" component={ThumbDownAltIcon} inheritViewBox onClick={removeLike} />:<SvgIcon className='likeButton' component={ThumbUpIcon} inheritViewBox  onClick={addLike}/> 
           }
        </div>
    </div>
  )
